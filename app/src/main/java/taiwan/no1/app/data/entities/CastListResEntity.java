...
public class CastListResEntity {
    private int page;
    private int total_results;
    private int total_pages;
    private List<CastBriefBean> results;
    ...
    public List<CastBriefBean> getResults() { return results;}

    public void setResults(List<CastBriefBean> results) { this.results = results;}
    ...
    public static class CastBriefBean {
