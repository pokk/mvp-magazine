...
public class LocalDataStore implements IDataStore {
    ...
    @Nullable
    @Override
    public Observable<SearchMovieEntity> searchMovieEntities(String language, String query, int page, boolean include_adult, String region, int year, int primary_release_year) {
        throw new Error("No-op");
    }
}
