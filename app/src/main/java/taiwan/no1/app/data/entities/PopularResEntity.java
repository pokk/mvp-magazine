...
public class PopularResEntity {
    private int page;
    private int total_results;
    private int total_pages;
    private List<PopularResEntity.MovieEntity> results;
    ...
    public List<PopularResEntity.MovieEntity> getMovieEntities() { return results;}

    public void setResults(List<PopularResEntity.MovieEntity> results) { this.results = results;}
    ...
    public static class MovieEntity {
        ...
        public void setOriginal_language(
                String original_language) { this.original_language = original_language;}
