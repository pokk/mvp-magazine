...
public class TvEpisodeDetail extends BaseUseCase<TvEpisodeDetail.Requests> {
    public TvEpisodeDetail(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
    ...
    protected Observable buildUseCaseObservable() {
        return this.repository.detailTvEpisode(this.requestValues.id,
                                               this.requestValues.seasonNumber,
                                               this.requestValues.episodeNumber);
    }
    ...
    public static final class Requests extends BaseUseCase.RequestValues {
        ...
        public Requests(int id, int seasonNumber, int episodeNumber) {
            this.id = id;
