...
public class TvLists extends BaseUseCase<TvLists.Requests> {
    public TvLists(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, IRepository repository) {
    ...
    protected Observable buildUseCaseObservable() {
        return this.repository.tvs(this.requestValues.category, this.requestValues.page);
    }
    ...
    public static final class Requests extends BaseUseCase.RequestValues {
        private final CloudDataStore.Tvs category;
        private final int page;

        public Requests(CloudDataStore.Tvs category, int page) {
