...
public final class YoutubeExtract {
    //region Fields
    ...
    //region Constructors
    public YoutubeExtract(String videoIdentifier) {
        mVideoIdentifier = videoIdentifier;
        mElFields = new ArrayList<>(asList("embedded", "detailpage", "vevo", ""));
    ...
    private YouTubeExtractorResult getYouTubeResult(String html)
        ...
        if (video.containsKey("url_encoded_fmt_stream_map")) {
            List<String> streamQueries = new ArrayList<>(asList(video.get("url_encoded_fmt_stream_map")
                                                                     .split(",")));
            ...
            return new YouTubeExtractorResult(videoUri,
                                              mediumThumbUri,
                                              highThumbUri,
                                              defaultThumbUri,
                                              standardThumbUri);
    ...
    public static final class YouTubeExtractorResult {
        ...
        private YouTubeExtractorResult(Uri videoUri, Uri mediumThumbUri, Uri highThumbUri,
                                       Uri defaultThumbUri, Uri standardThumbUri) {
            mVideoUri = videoUri;
